...
const autoScroll = () => {
  // On ne fait défiler automatiquement que si la souris (ou le doigt) n'est pas dessus 
...
const metrics = [
  {
    ...
    borderColor: "group-hover:border-[#0071bd] group-active:border-[#0071bd]"
  },
  {
    value: "20 Ans",
    ...
    borderColor: "group-hover:border-[#38a935] group-active:border-[#38a935]"
  },
  {
    value: "20",
    ...
    borderColor: "group-hover:border-[#ffe900] group-active:border-[#ffe900]"
  },
  {
    value: "2",
    ...
    <div class="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 xl:grid-cols-12 gap-8 lg:gap-10 items-center">
        ...
        <div class="xl:col-span-9 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
          ...
          >
            ...
            <div 
              class="relative flex flex-col gap-3 py-5 px-6 bg-white border border-[#0071bd]/10 transition-transform duration-300 ease-out z-10 group-hover:-translate-x-1 group-hover:-translate-y-1 group-active:-translate-x-1 group-active:-translate-y-1"
      ...
      <div class="max-w-5xl mx-auto mb-20">
        <div class="relative group">
          ...
          <div class="relative bg-white border border-[#0071bd]/10 flex flex-col md:flex-row z-10 transition-transform duration-300 group-hover:-translate-x-1 group-hover:-translate-y-1 group-active:-translate-x-1 group-active:-translate-y-1">
            
            <div class="w-full md:w-2/5 relative h-56 md:h-auto overflow-hidden bg-[#38a935] shrink-0">
              <div class="absolute inset-0 bg-[#38a935]/20 z-10 group-hover:bg-[#38a935]/10 group-active:bg-[#38a935]/10 transition-colors duration-500"></div>
              <img :src="siege.image" :alt="'Vue de ' + siege.name" class="w-full h-full object-cover group-hover:scale-105 group-active:scale-105 transition-transform duration-700 ease-out" />
            ...
            <div class="w-full md:w-3/5 relative p-8 md:p-10 lg:p-12 flex flex-col justify-center">
              ...
              <div class="absolute -top-10 md:top-1/2 md:-translate-y-1/2 left-6 md:-left-12 w-20 h-20 bg-white border border-[#0071bd]/10 z-20 flex items-center justify-center shadow-md group-hover:scale-105 group-active:scale-105 transition-transform duration-300">
              ...
              <div class="md:ml-8 lg:ml-12">
                ...
                <a :href="siege.url" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-3 group/link">
                  <span class="w-8 h-8 rounded-full bg-[#0071bd]/5 flex items-center justify-center text-[#0071bd] group-hover/link:bg-[#0071bd] group-active/link:bg-[#0071bd] group-hover/link:text-white group-active/link:text-white transition-colors duration-300">
                    <i class="ri-arrow-right-line text-sm"></i>
                  </span>
                  <span class="text-[11px] font-bold text-[#0071bd] group-hover/link:text-[#38a935] group-active/link:text-[#38a935] transition-colors uppercase tracking-widest">
      ...
      <div class="w-full border-t border-[#0071bd]/10 pt-10">
        ...
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-8">
          ...
          <div class="flex items-center gap-1 border border-[#0071bd]/0 p-0.5 bg-white shrink-0">
            <button 
              @click="slideLeft" 
              class="w-8 h-8 flex items-center justify-center text-[#0071bd]/50 hover:bg-[#0071bd]/5 active:bg-[#0071bd]/10 hover:text-[#0071bd] active:text-[#0071bd] transition-colors focus:outline-none"
          ...
          >
            <div class="flex gap-8 shrink-0">
              <a 
                ...
                class="group relative block w-48 h-24 bg-white border border-[#0071bd]/10 p-5 transition-all hover:border-[#0071bd] active:border-[#0071bd] focus:outline-none"
              >
                <div class="absolute inset-0 bg-[#ffe900]/10 opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity pointer-events-none"></div>
                <img 
                  :src="partner.Image" 
                  :alt="'Image ' + partner.name" 
                  class="w-full h-full object-contain filter contrast-125 group-hover:grayscale-0 group-active:grayscale-0 transition-all duration-300"
                />
              </a>
            </div>
